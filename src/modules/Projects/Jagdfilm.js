            ...
            <div className="section_two">
                <div className="nav_button_div">
                    <div className="left_nav_span ">
                        ...
                        <Link to="/imagefilm" > <span className="left_nav_label">vorheriges Projekt</span></Link>
                    </div>
                    <div className="right_nav_span">
                        <Link to="/productfilm" ><span className="right_nav_label">Nächstes Projekt</span></Link>
